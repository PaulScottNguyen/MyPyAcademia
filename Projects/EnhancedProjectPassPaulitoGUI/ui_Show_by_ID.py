...
################################################################################
## Form generated from reading UI file 'Show_by_ID.ui'
##
...
"")
        ...
        self.listViewID = QListView(self.centralwidget)
        self.listViewID.setObjectName(u"listViewID")

        self.listViewID.setStyleSheet(u"color: black; background: white;\n"
"border-color: rgb(0, 0, 0);\n"
"")

        self.verticalLayout.addWidget(self.listViewID)

        self.Menu_ID_Button = QPushButton(self.centralwidget)
        self.Menu_ID_Button.setObjectName(u"Menu_ID_Button")
        font = QFont()
        font.setPointSize(18)
        font.setBold(True)
        self.Menu_ID_Button.setFont(font)
        self.Menu_ID_Button.setStyleSheet(u"background: #16476A;\n"
"color: white;")

        self.verticalLayout.addWidget(self.Menu_ID_Button)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText("")
        self.Menu_ID_Button.setText(QCoreApplication.translate("MainWindow", u"Menu", None))
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Show By ID:", None))
