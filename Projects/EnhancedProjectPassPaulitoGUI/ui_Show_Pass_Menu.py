...
################################################################################
## Form generated from reading UI file 'Show_Pass_Menu.ui'
##
...
"")
        ...
        self.Show_By_ID_Button = QPushButton(self.centralwidget)
        self.Show_By_ID_Button.setObjectName(u"Show_By_ID_Button")
        font = QFont()
        font.setPointSize(18)
        font.setBold(True)
        self.Show_By_ID_Button.setFont(font)
        self.Show_By_ID_Button.setStyleSheet(u"background: #16476A;\n"
"color: white;")

        self.verticalLayout.addWidget(self.Show_By_ID_Button)

        self.verticalSpacer = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.verticalLayout.addItem(self.verticalSpacer)

        self.Show_By_Web_Button = QPushButton(self.centralwidget)
        self.Show_By_Web_Button.setObjectName(u"Show_By_Web_Button")
        self.Show_By_Web_Button.setFont(font)
        self.Show_By_Web_Button.setStyleSheet(u"background: #16476A;\n"
"color: white;")

        self.verticalLayout.addWidget(self.Show_By_Web_Button)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText("")
        self.Show_By_ID_Button.setText(QCoreApplication.translate("MainWindow", u"Show by ID", None))
        self.Show_By_Web_Button.setText(QCoreApplication.translate("MainWindow", u"Show by Web", None))
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Show All Passwords:", None))
